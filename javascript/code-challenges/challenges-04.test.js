...
const updateAnimal = (arr, upper) => { return arr.map((element)=>{return upper(element)})
  // Solution code here...
};
...
const sortNumbers = (arr) => { return arr.sort((arr1,arr2) => { return parseFloat(arr1)- parseFloat(arr2)})
  // Solution code here...
};
...
const sortBackwards = (arr) => {return arr.sort((arr1,arr2) => { return -(parseFloat(arr1)- parseFloat(arr2))})
  // Solution code here...
};
