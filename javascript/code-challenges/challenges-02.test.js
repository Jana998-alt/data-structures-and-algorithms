...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let powered = arr.map(function(num){
    return num*num*num
  })
  return powered;
};
...
const addOne = (arr) => {
  // Solution code here...
  let incremented = arr.map(function increment(element) {
    return element+1;
  })
  return incremented;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let questioning = arr.map(function question (string){
    return string+'?';
  })
  return questioning;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  return arr.forEach((element) => {Math.pow(2,element)});
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let powerTwo = arr.map(function powerTheTwo(element){
